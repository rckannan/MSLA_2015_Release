...
namespace MSLA.Server.Login
{
    ...
    {
        LogonResult FetchLogonInfo(Guid sessionId);
        Security.SimpleUserInfo SaveLogonInfo(LogonResult myLogonResult);
    }
    ...
    public class LogonService : ILogonService
    {
        ...
        public static LogonResult FetchLogonInfo(Guid sessionId)
        {
            Byte[] obj_bytes;
            ...
            using (SqlConnection cn = Data.DataAccess.GetCn(Data.DBConnectionType.MainDB))
            {
                ...
                cmm.Parameters.Add("@Session_ID", System.Data.SqlDbType.UniqueIdentifier).Value = sessionId;
        ...
        SimpleUserInfo ILogonService.SaveLogonInfo(LogonResult myLogonResult)
        {
            return SaveLogonInfo(myLogonResult);
        }
        ...
        LogonResult ILogonService.FetchLogonInfo(Guid sessionId)
        {
            return FetchLogonInfo(sessionId);
        }
    }
}
