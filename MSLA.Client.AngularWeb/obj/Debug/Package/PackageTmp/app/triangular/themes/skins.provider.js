(function() {
    ...
    angular
        .module('Arror.UI.themes')
        .provider('arrSkins', skinsProvider)
        .run(addSkinToScope);

    /* @ngInject */
    function skinsProvider($mdThemingProvider, arrThemingProvider) {
        var skins = {};
        ...
        return {
            skin: function(id, name) {
                ...
                var skin = new Skin(id, name, $mdThemingProvider, arrThemingProvider);
    ...
    /* @ngInject */
    function Skin(id, name, $mdThemingProvider, arrThemingProvider) {
        ...
        self.loadThemes = function() {
            ...
            for (var element in self.elements) {
                ...
                var theme = arrThemingProvider.theme(self.elements[element]);
    ...
    /* @ngInject */
    function addSkinToScope($rootScope, arrSkins) {
        $rootScope.triSkin = arrSkins.getCurrent();
    }
})();