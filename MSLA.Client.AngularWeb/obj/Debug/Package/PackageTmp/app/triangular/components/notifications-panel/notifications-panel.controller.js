(function() {
    ...
    /* @ngInject */
    function NotificationsPanelController($scope, $http, $mdSidenav, $mdDialog, arrException, API_CONFIG) {
        var vm = this;
        ...
        vm.emails = arrException.exceptions;
        ...
        function openEmail(email, $event) {
            $mdDialog.show({
                controller: 'ErrorNotiDialogController',
                controllerAs: 'vm',
                templateUrl: 'app/triangular/components/notifications-panel/errorNotification-dialog.tmpl.html',
                locals: {
                    email: email
                },
                targetEvent: $event
